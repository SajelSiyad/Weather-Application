...
//
//     final currentDataModel = currentDataModelFromJson(jsonString);

import 'dart:convert';

CurrentDataModel currentDataModelFromJson(String str) =>
    CurrentDataModel.fromJson(json.decode(str));

String currentDataModelToJson(CurrentDataModel data) =>
